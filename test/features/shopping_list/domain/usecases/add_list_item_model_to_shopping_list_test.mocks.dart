...
// in bite_buddy/test/features/shopping_list/domain/usecases/add_list_item_model_to_shopping_list_test.dart.
...
class MockInputConverter extends _i1.Mock implements _i3.InputConverter {
  ...
  @override
  _i2.Either<_i4.Failure, _i5.ListItemModel> stringToListItem(String? str) =>
      (super.noSuchMethod(
        Invocation.method(
          #stringToListItem,
          [str],
        ),
        returnValue: _FakeEither_0<_i4.Failure, _i5.ListItemModel>(
          this,
          Invocation.method(
            #stringToListItem,
            [str],
      ...
      ) as _i2.Either<_i4.Failure, _i5.ListItemModel>);
}
